...
// Default coordinates
    ...
    map.on('load', () => {
        ...
        fetch('../../../Armando/geojson/biciEstacionamiento/biciestacionamientos.json')
            .then(response => response.json())
            .then(data => {
        ...
        fetch('../../../Armando/geojson/puntoArribo/puntos-de-arribio-de-monopatines-elctricos-y-bicicletas.json')
            .then(response => response.json())
            .then(data => {
        ...
        fetch("../../../Armando/geojson/cicloVias/infraestructura-vial-ciclista.json")
            .then(response => response.json())
            .then(data => {
        ...
        // Fetch the JSON file
        fetch('../../../Armando/geojson/vialidadesPrimarias/mapa-de-las-vialidades-primarias-de-la-ciudad-de-mxico-.json')
            .then(response => response.json())
            .then(data => {
                // Create a GeoJSON object with the fetched data
                const geojson = {
